  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-8">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {resources.map((resource, index) => {
            ...
            return (
              <Card 
                key={resource.title} 
                className="rounded-2xl border border-blue-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
        ...
        <Card className="rounded-2xl border border-blue-200 shadow-lg mt-12 bg-gradient-to-r from-blue-600 to-blue-700">
          <CardContent className="p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button className="bg-white text-blue-600 hover:bg-blue-50 font-semibold px-8 py-3 rounded-xl">
                Explore All Resources
              </Button>
              <Button variant="outline" className="border-white text-white hover:bg-blue-500 font-semibold px-8 py-3 rounded-xl">
                Get Career Advice
              </Button>
            </div>
          </CardContent>
