    ...
    return (
      <div className="space-y-4">
        <div className="bg-primary-50 border border-primary-200 rounded-xl p-6 text-center">
          ...
          <h3 className="text-lg font-medium text-primary-800 mb-2">Unable to load profile</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        {validationErrors.hr_mobile && (
                          <p className="mt-1 text-sm text-primary-600">{validationErrors.hr_mobile}</p>
                        )}
                      </div>
                    </div>
                  </InfoSection>
...
function InfoItem({ label, value, icon, isLink = false, status }) {
  ...
  const getStatusColor = (status) => {
    const colors = {
      ...
      error: "text-primary-600 bg-primary-100"
    };
